...
/**
 * All players have responded and voted and the dasher has adjusted scores. Time for the next dasher & card.
 * @param data Sent from the client. Contains the current round and gameId (room)
 */
function hostNextRound(data) {
    if(data.round < wordPool.length ){
        // Send a new card back to the dasher and players.
...
function playerAnswer(data) {
    ...
    io.sockets.in(data.gameId).emit('hostRecvAnswer', data);
}
 ...
 */
function sendCard(wordPoolIndex, gameId) {
